    ...
    return (
      <ContentLayout title="Core Web Vitals - as principais métricas da web">
        <Text>
          ...
          algoritmo de busca do Google passará a levar em consideração as
          métricas de performance de uma página web, chamadas de{" "}
        ...
        <Text>
          ...
          <br />
          <br />
          Sempre utilizo os formatos de imagens mais adequados para cada
          situação, como <strong>WebP</strong> e <strong>AVIF</strong>, que são
          formatos mais modernos e que oferecem melhor qualidade e menor tamanho
          de arquivo. O lazy loading também é uma ótima opção para otimizar o
          carregamento.
          <br />
          <br />
          Para a otimização de imagens, utilizo o Next.js Image, que é uma
          funcionalidade nativa do framework, ou o ImageKit, que é uma
          ferramenta que oferece diversas funcionalidades para otimização de
          imagens, como redimensionamento, compressão, entre outras.
          <br />
          <br />
          <Heading as="span" color="green">
            Fontes
          ...
          utilizadas, como o uso de placeholders, Skeletons, que são animações
          de carregamento, o recente React Suspense, entre outras que são ótimas
          opções.
          <br />
          <br />
          <br />
