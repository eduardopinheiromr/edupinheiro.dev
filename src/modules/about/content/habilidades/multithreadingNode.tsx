...
export const multithreadingNode: Content = {
  render: () => {
    ...
    `;
    return (
      <ContentLayout title="Como escalar APIs Node.js com multithreading">
        Quando se trata de escalar uma API Node.js, a primeira coisa que vem na
        cabeça é utilizar o cluster do Node.js, que é um módulo que permite a
        criação de múltiplos processos, cada um com sua própria instância do
        servidor.
        <br />
        <br />
        ...
        <br />
        <br />
        <ChakraCodeBlock language="typescript" snippet={startSnippet} />
        <br />
        <br />
