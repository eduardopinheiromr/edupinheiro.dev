...
export const chakraTradeoff: Content = {
  render: () => {
    return (
      <ContentLayout title="Chakra UI e seu tradeoff">
        ...
        <br />
        <br />
        Em projetos que a performance é um fator muito importante e há um prazo
        de entrega compatível, tenho bons resultados com o{" "}
